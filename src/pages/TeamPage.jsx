  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://music-through-the-lens.onrender.com/team"
        />
        <meta property="og:image" content="[URL to team photo or logo]" />
        <link
          rel="canonical"
          href="https://music-through-the-lens.onrender.com/team"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: "https://music-through-the-lens.onrender.com/team",
            publisher: {
              "@type": "Organization",
